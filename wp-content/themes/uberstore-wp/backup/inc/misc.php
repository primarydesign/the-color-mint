...
function thb_wishlist_button() {
	...
	if ( class_exists( 'YITH_WCWL_UI' ) )  {
		...
		$html .= '<div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;"><span class="feedback">' . __( 'Product added to wishlist.', THB_THEME_NAME ) . '</span> <a href="' . esc_url($url) . '" class="add_to_wishlist"><i class="fa fa-heart"></i></a></div>';
		$html .= '<div class="yith-wcwl-wishlistexistsbrowse ' . ( $exists ? 'show' : 'hide' ) . '" style="display:' . ( $exists ? 'block' : 'none' ) . '"><a href="' . esc_url($url) . '" class="add_to_wishlist"><i class="fa fa-heart"></i></a></div>';
